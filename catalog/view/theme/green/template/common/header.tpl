<<<<<<< HEAD
    ...
    <head>
      ...
      <?php } ?>
      <link rel="stylesheet" type="text/css" href="catalog/view/theme/green/stylesheet/stylesheet.css" />
        ...
        <header class="header-top">
          <div class="container">
            <div class="row menu-top">
              <div class="pull-left phone-top">
                <i class="glyphicon glyphicon-phone"></i>
                <strong>Подзвоніть нам:</strong> +38(067)111-11-11
              </div>
              <div class="pull-right">
                <ul class="links">
                  <li><a href="index.php?route=information/contact">Контакти</a></li>
                  <li class="dropdown"><?php echo $currency; ?></li>
