...
<div id="content"><div class="col-md-10"><?php echo $content_top; ?>
      ...
      <div class="description">
        ...
        <div class="cart">
          <div>
            ...
            <a href="javascript:void(0);" id="product-quantity-down" class="button btn btn-default"><i class="glyphicon-minus"></i></a>
            <input type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" class="form-control" id="product-quantity"/>
            <a href="javascript:void(0);" id="product-quantity-up" class="button btn btn-default"><i class="glyphicon-plus"></i></a>
            <input type="hidden" name="product_id" size="2" value="<?php echo $product_id; ?>" />
            &nbsp;
            <input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="button btn pull-left" />
            <div class="clearfix"></div>
            <?php if ($minimum > 1) { ?>
            <div class="minimum"><?php echo $text_minimum; ?></div>
            <?php } ?>
            <hr/>
            <span class="links"><a onclick="addToWishList('<?php echo $product_id; ?>');" class="btn btn-default pull-left"><?php echo $button_wishlist; ?></a>
              <a onclick="addToCompare('<?php echo $product_id; ?>');" class="btn btn-default"><?php echo $button_compare; ?></a>
            </span>
          </div>
